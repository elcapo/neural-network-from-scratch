...
def test_network_backward_method():
    ...
    network.backward(Y, learning_rate=0.01)

    assert not np.array_equal(network.output_layer.W, initial_output_weights), (
        "Backward method should update output layer weights"
    )
